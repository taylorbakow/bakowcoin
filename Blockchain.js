...
class Blockchain{
    ...
    minePendingTransactions(miningRewardAddress){
        ...
        //fix for Blockchain.minePendingTransactions(miningRewardAddress)
    ...
    addTransaction(transaction){
        ...
        if(!transaction.fromAddress || !transaction.toAddress){
            throw Error('Transaction must have a from and to address');
        }
        if(!transaction.isValid()){
            throw Error("Can not add invalid transaction to chain");
        }

        //add to Blockchain.addTransaction()
